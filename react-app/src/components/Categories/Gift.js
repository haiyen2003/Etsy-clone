...
function GiftCategory() {
    ...
    //     return homeproducts
    //
    let categoryproducts = allproducts.filter(product => product?.category == "Personalized Gifts")
    ...
    return (
        <div className='category-container'>
            ...
            <div className='all_products_container_outermost'>
                <div>
                    <h1 className="category-container-header">Find something you love in Personalized Gifts</h1>
                </div>
                        ...
                        <div calssName='category_product' key={product.id}>
                            ...
                            <NavLink to={`/products/${product.id}`} className='category_product_navlink'>
                                ...
                                <div className='category_productinfo'>
                                    <div style={{ fontweight: '700' }}> {product?.name.slice(0, 56) + '...'}</div>
