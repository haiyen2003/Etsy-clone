...
function JewelryCategory() {
    ...
    //     return homeproducts
    //
    let categoryproducts = allproducts.filter(product => product?.category == "Jewelry & Accessories")
    ...
    return (
        <div className='category-container'>
            {/* <div>
                <h1 className="category-container-header">Find something you love in Jewelry & Accessories</h1>
            </div> */}
